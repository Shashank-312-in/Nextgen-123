...
const ICONS = {
  ...
  // Upload cloud – historical attendance import (HOD)
  attendanceImport: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export function navItemsFor(role: Role, options?: { smsGatewayAccess?: boolean }): NavItem[] {
  ...
  return [
    ...
    { href: "/academic-calendar", icon: ICONS.calendar, label: "Academic Calendar", key: "academic-calendar" },
      { href: "/timetable", icon: ICONS.timetable, label: "Timetable", key: "timetable" },
    { href: "/attendance/import", icon: ICONS.attendanceImport, label: "Import Attendance", key: "attendance-import" },
    { href: "/audit-log", icon: ICONS.audit, label: "Audit Log", key: "audit" },
